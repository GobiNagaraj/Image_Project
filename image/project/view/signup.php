 ...
 ?>
	...
	<?php 
	 ...
	 ?>
		...
		<img src="../images/Gobi/SignUp_toLogo.jpg" style="margin-left: 380px; width: 400px; height: 250px">
		<form method="POST" action="../controller/sign-up-controller.php">
			...
			<input type="image" src="../images/Gobi/sign-up-logo.jpg" name="gobi" alt="Submit" style="margin-left: 500px; width: 80px; height: 80px" />
